...
export const mockK8sPipelineRuns: PipelineRunKind[] = [
  {
  ...
  },
  {
    ...
    metadata: {
      ...
      uid: 'a271f311-c9c9-473d-86f1-91628a717d66',
      creationTimestamp: '2024-06-14T07:04:32Z',
      generation: 1,
      namespace: 'test-namespace',
      finalizers: ['chains.tekton.dev/pipelinerun'],
      labels: {
        'tekton.dev/pipeline': 'hello-goodbye-2',
      },
    },
    spec: {
      params: [
