...
import { SucceedConditionReason } from './pipelinerun-utils';
import { getTaskRunsForPipelineRun } from './task-run-utils';
...
export const totalPipelineRunTasks = (pipelinerun: PipelineRunKind | null): number => {
